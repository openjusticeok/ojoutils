...
function provides a standardized way to create new R projects for Open
Justice Oklahoma. It sets up a project with our standard directory
structure, initializes version control, and configures common
dependencies.
...
- `private`: Whether the GitHub repository should be private (defaults
  to TRUE)
